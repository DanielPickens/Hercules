...
import (
	...
	"github.com/danielpickens/hercules/hercules/internal/issues"
	"github.com/danielpickens/hercules/hercules/internal/report"
	"github.com/danielpickens/hercules/hercules/pkg/config"
...
func TestBuilderHtml(t *testing.T) {
	...
	o := issues.Outcome{
		"pickens": issues.Issues{
			issues.New(client.NewGVR("dan"), issues.Root, config.OkLevel, "Blah"),
		},
	}

	ta.Rollup(o)
	b.AddSection(client.NewGVR("dan"), "dan", o, ta)
...
func TestTitleize(t *testing.T) {
	uu := map[string]struct {
		...
		"none": {count: -1, title: "DAN", e: "DAN"},
		"one":  {count: 1, title: "DAN", e: "DAN (1 SCANNED)"},
		"many": {count: 2, title: "DAN", e: "DAN (2 SCANNED)"},
	}
